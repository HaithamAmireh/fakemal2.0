...
function Header() {
    return (
        ...
        {/* // <header className="bg-teal-800 flex flex-row lg:flex-col justify-between lg:items-center lg:p-3"> */}
            <Nav />
            <a href="/home" className="text-white text-lg md:text-xl lg:text-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:text-gray-700 ">
                FAKEMAL
            </a>
        </header>
    )
